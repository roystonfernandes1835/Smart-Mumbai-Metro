  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#07090F]/80 backdrop-blur-xl border-b border-white/10 px-6 py-4 flex items-center justify-between">
      ...
      <div className="flex gap-6 items-center">
        ...
        <Link to="/feedback" className={`text-sm font-medium transition-colors ${loc.pathname === '/feedback' ? 'text-orange-400' : 'text-gray-400 hover:text-white'}`}>Feedback and Complaints</Link>

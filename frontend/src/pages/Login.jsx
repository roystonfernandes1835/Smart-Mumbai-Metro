...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isSignUp) {
        // Automatically log in after registration by switching to login route internally
        // In a real app we'd get a token from register, but here we'll just show a success message
        // and let the user click sign in, or we could auto-trigger the login fetch.
        // Let's do the improved UX: show success and switch to sign in mode.
        setIsSignUp(false);
        setIsLoggingIn(false);
        setError('Account created! Access terminal with your new password.');
        return;
      }

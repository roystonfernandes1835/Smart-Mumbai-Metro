...
export default function FeedbackPage() {
  ...
  const submitFeedback = () => {
    ...
    addFeedback({ id, ratings, comment: fbComment, submittedBy: user?.name || 'Guest', submittedAt: new Date().toISOString() });
  ...
  const submitComplaint = () => {
    ...
    addComplaint({ id, station, category, severity, description, imageB64, submittedBy: user?.name || 'Guest', submittedAt: new Date().toISOString(), status: 'Pending' });
  ...
  return (
    <div className="mt-8 mb-20 max-w-4xl mx-auto px-4">
      ...
      <div className="flex items-center gap-4 mb-8 fu">
        ...
        <div>
          <h1 className="text-3xl font-black text-white tracking-wide">Feedback & Complaints</h1>
